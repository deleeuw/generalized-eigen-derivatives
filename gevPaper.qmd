...
The GSVD system \eqref{eq-gsvdef1a}-\eqref{eq-gsvdef4a} is closely related to the GEVD system
\begin{equation}
\begin{bmatrix}
0&F\\F'&0
\end{bmatrix}
...
Thus, in stead of tackling the GSVD in \eqref{eq-gsvdef1a}-\eqref{eq-gsvdef4a}
