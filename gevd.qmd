...
Suppose $A$ and $B$ are real symmetric matrices of order $n$, with $B$ positive definite (PSD, from now on). Generalized eigenvalues and eigenvectors are defined as the solutions $(x,\lambda)$ of the system of equations 
\begin{subequations}
\begin{align}
